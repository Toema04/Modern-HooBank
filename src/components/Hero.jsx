...
const Hero = () => (
	<section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
		<div className={`flex ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
			...
			<h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[74px] w-full">
				{" "}
				Payment Method.
			</h1>
		...
		<div className={` flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
			...
			<div className="absolute z-[1] rounded-full bottom-40 white__gradient w-[80%] h-[80%] " />
